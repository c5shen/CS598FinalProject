...
parser.add_argument('-p', '--penalty', default=1.0, type=float,
                    help='Penalty for eliminate a mutation [default: 1.0]')
...
# @Chengze 4.26.2021 - Commented out this constraint to penalize elimination
...
for j in range(numMutations):
    ...
    # @Chengze 4.26.2021 - Added penalty for eliminating a mutation
    objective -= penalty * K[j]
